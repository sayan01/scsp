...
namespace scsp.Migrations
{
    ...
    [Migration("20221014014559_user many-to-many")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("scsp.Models.Relation", b =>
                {
            ...
            modelBuilder.Entity("scsp.Models.Relation", b =>
                {
                    b.HasOne("scsp.Models.User", "UserFrom")
                        .WithMany("Follows")
                        .HasForeignKey("FromId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("scsp.Models.User", "UserTo")
                        .WithMany("FollowedBy")
                        .HasForeignKey("ToId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
