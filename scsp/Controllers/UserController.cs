...
namespace scsp.Controllers
{
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Username,PasswordHash,FirstName,LastName,Bio,PhotoId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Username,PasswordHash,FirstName,LastName,Bio,PhotoId")] User user)
        {
            if (id != user.Username)
            {
                return NotFound();
